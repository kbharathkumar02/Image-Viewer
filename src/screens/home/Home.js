...
class Home extends Component {
    ...
    componentWillMount() {
        ...
        if (this.state.accessToken === null || this.state.accessToken === "") {
            ...
            var url1 = 'https://api.instagram.com/v1/users/self/?access_token='+ this.state.accessToken;
            xhrUserInfo.open('GET', url1);
            ...
            xhrUserPosts.open('GET', 'https://api.instagram.com/v1/users/self/media/recent?access_token='+ this.state.accessToken);
